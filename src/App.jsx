...
export default function App() {
  ...
  function practiceMode(mode) {
    const next = challenges.find(c => c.mode === mode && c.unlocked && !c.completed) || challenges.find(c => c.mode === mode && c.unlocked)
    if (user && next) start(next)
    else explore(mode)
  }
